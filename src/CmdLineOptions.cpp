    ...
    CmdLineOptions::CmdLineOptions(int acc, const char *avv[]) {
        ...
        desc.add_options()
                ...
                ("enable-emission-monitor", value<bool>()->default_value(false)->implicit_value(true),
                 "enable Remix total emission monitoring thread")
                ...
                ("bc-path,b", value<string>(),
                 "path to lmdb folder of the blockchain, e.g., ~/.remix/lmdb")
                ...
                ("deamon-url,d", value<string>()->default_value("http:://127.0.0.1:21331"),
                 "Remix deamon url");
